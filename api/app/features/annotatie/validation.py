...
`references`/`scripts`-inhoudsbron), zodat de api niet drift ten opzichte van het skill-spoor.
`router.py` valideert de klasse van een voorgesteld element hiertegen.
"""
...
from ...shared.config import SKILL_SCRIPTS
