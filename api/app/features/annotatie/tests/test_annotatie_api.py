...
async def client(monkeypatch):
    ...
    from app.shared import db, ratelimit
    from app.features.annotatie.contracts import AnnotatieDocument
    from app.features.annotatie.store import AnnotatieStore
    from app.shared.config import get_settings
    from app.features.annotatie.router import get_annotatie_store
...
async def test_beslis_op_element_atomair_behoudt_andere_besluiten(client):
    ...
    from app.features.annotatie.contracts import Lifecycle
    from app.features.annotatie.store import GEEN_ELEMENT, AnnotatieStore
...
async def test_legacy_element_met_mens_herkomst_wordt_gerepareerd(client):
    ...
    from app.features.annotatie.contracts import AnnotatieElement
