...
async def client(monkeypatch):
    ...
    from app.features.gesprekken.router import get_gesprek_store
    from app.features.gesprekken.models import Gesprek
    from app.features.gesprekken.store import GesprekStore
...
async def test_gedeactiveerde_gebruiker_verliest_toegang(client):
    ...
    from app.features.identiteit_toegang.router import vergeet_actief
