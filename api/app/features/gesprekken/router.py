...
de vertrouwde `X-User-Id`-header die de BFF uit de ingelogde sessie zet (`actieve_userid`, hergebruikt
uit identiteit_toegang); de router zit achter de client-bearer (`require_client`).
...
from ...shared.auth import require_client
...
from .store import GesprekStore
