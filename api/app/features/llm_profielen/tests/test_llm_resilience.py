...
from app.features.llm_profielen.llm import throttle
...
def test_prompt_guard_werpt_bij_overschrijding():
    from app.features.llm_profielen.llm.base import LlmConfig, PromptTooLargeError
    from app.features.llm_profielen.llm.litellm_client import LiteLLMClient
...
def test_prompt_guard_laat_klein_door_en_noop_zonder_limiet():
    from app.features.llm_profielen.llm.base import LlmConfig
    from app.features.llm_profielen.llm.litellm_client import LiteLLMClient
