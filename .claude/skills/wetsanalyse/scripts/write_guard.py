...
Geldt voor de wetsanalyse-werkmap onder analyses/:
  1. analyses/**/werk/**/feedback.json    — alleen de review-server schrijft dit; nooit de skill.
  2. analyses/**/werk/**/analyse.json     — immutabel zodra de ronde VOLTOOID is, d.w.z.
...
# Beide patronen matchen een willekeurige werk/-boom onder analyses/.
...
def main() -> None:
    ...
    if _ANALYSE.search(file_path):
        # Een ronde-resultaat (analyse.json) in werk/ wordt immutabel zodra de ronde
